    ...
    <div id='Card' className="bg-gradient-to-r from-black to-pink-300  mx-auto px-4 py-8">
      <h2>
        <BlurText
          ...
          animateBy="words"
          direction="top"
          className='text-4xl capitalize font-bold text-center mb-6 text-white'
        />
      </h2>
      <h1 className="text-4xl font-bold text-white">Daily Use Purpose</h1>
      <Swiper
            ...
            >
              ...
              <div className="p-4">
                ...
                <Link to={`/product/${product.id}`}>
                  <button className="bg-black text-white w-full py-2 rounded-lg mt-4 hover:bg-black/30 transition duration-300">
                    View details
                  </button>
                </Link>
              </div>
